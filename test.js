...
test('result contains no outer html element when fragment is truthy', t => {
  const generated = html2pug('<h1>Hello World!</h1>');
...
test('single quotes in attribute values are escaped', t => {
  const generated = html2pug(`<button aria-label="closin&apos;" onclick="window.alert('bye')">close</button>`, {});
...
test('collapses boolean attributes', t => {
  const generated = html2pug(`<input type="text" name="foo" disabled="disabled" readonly="readonly" />`, {});
